    ...
    <header class="flex items-center justify-between px-8 py-3 border-b-2 border-gray-300 bg-[#f0f0f0]">
        ...
        <div class="flex-1 max-w-lg mx-8 mt-2">
            <div class="relative flex items-center w-full h-10 border-2 border-black bg-white rounded-sm overflow-hidden">
                <input type="text" placeholder="Search Item" class="w-full h-full px-4 outline-none text-center font-serif text-lg" style="font-variant: small-caps;">
        ...
        <div class="flex items-center gap-4 mt-2">
            ...
            <div class="w-12 h-12 rounded-full border-[3px] border-[#f0a518] bg-gray-300 flex items-center justify-center overflow-hidden">
